...
model.load_weights("/media/shareit/weights/ssd300_mobilenet_city_map_v2/ssd300_epoch-500.h5",by_name = True, skip_mismatch = True)
...
checkpoint = ModelCheckpoint('/media/shareit/weights/ssd300_mobilenet_inidan_Datset/ssd300_epoch-{epoch:02d}.h5')

# terminate_on_nan = TerminateOnNaN()

tensorborad = TensorBoard(log_dir='/media/shareit/weights/ssd300_mobilenet_inidan_Datset/logs',
