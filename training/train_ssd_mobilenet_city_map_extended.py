...
model.load_weights("/media/shareit/weights/ssd300_mobilenet_city_map/ssd300_epoch-49.h5" ,by_name = True, skip_mismatch = True)
...
train_hitech_file = "/home/manish/ssd-cutomize-manish/data/city_map_indian_train.txt"
valid_hitech_file = "/home/manish/ssd-cutomize-manish/data/city_map_indian_val.txt"
...
checkpoint = ModelCheckpoint('/media/shareit/weights/ssd300_mobilenet_city_map/ssd300_epoch-{epoch:02d}.h5')

# terminate_on_nan = TerminateOnNaN()

tensorborad = TensorBoard(log_dir='/media/shareit/weights/ssd300_mobilenet_city_map/logs',
