...
predictor_sizes = [model.get_layer('conv11_mbox_conf_v1').output_shape[1:3],
...
checkpoint = ModelCheckpoint('/media/shareit/weights/ssd300_mobilenet_city_map_v2/ssd300_epoch-{epoch:02d}.h5')

# terminate_on_nan = TerminateOnNaN()

tensorborad = TensorBoard(log_dir='/media/shareit/weights/ssd300_mobilenet_city_map_v2/logs',
